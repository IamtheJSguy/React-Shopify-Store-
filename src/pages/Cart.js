...
{console.log(address,'address')}
                    ...
                    <br/>
                    <div style={{width:'100%',}}>
                    <Button disabled={address === "" || city === "" || province === "" || array.length == 0 ? true: false} variant="outlined" style={{margin:'0px auto',display:'flex'}} onClick={()=>setOpenOrder(true)}>CASH ON DELIVERY</Button>
                    <br />
                    <Button disabled={address === "" || city === "" || province === "" ||  array.length == 0 ? true: false} variant="outlined" style={{margin:'0px auto',display:'flex'}} onClick={()=>setOpenOrderC(true)}>PAYMENT THROUGH CARD</Button>
                    </div>
                    <br/>
                    <br/>
                    </Paper>
